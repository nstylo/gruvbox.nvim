...
local base_group = lush(function()
  return {
    ...
    GruvboxFg3 {fg = fg3},
    GruvboxFg4 {fg = fg4},
    GruvboxFg0Bold {fg = fg0, gui = styles.bold},
    GruvboxFg1Bold {fg = fg1, gui = styles.bold},
    GruvboxFg2Bold {fg = fg2, gui = styles.bold},
    GruvboxFg3Bold {fg = fg3, gui = styles.bold},
    GruvboxFg4Bold {fg = fg4, gui = styles.bold},
    GruvboxGray {fg = gray},
    GruvboxBg0 {fg = bg0},
    GruvboxBg1 {fg = bg1},
    GruvboxBg2 {fg = bg2},
